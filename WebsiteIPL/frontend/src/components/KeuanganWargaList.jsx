...
const HasilKeuanganList = () => {
  ...
  const getHasilKeuangans = async () => {
    try {
      const response = await axios.get(
        `http://localhost:5000/lapkeuangans/warga`
      );
  ...
  const getKeuangans = async () => {
    const response = await axios.get("http://localhost:5000/keuangans/warga");
...
export default HasilKeuanganList;
